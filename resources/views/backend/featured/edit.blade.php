...
@section('content')
  <div class="sl-mainpanel">
      <nav class="breadcrumb sl-breadcrumb">
        ...
        <a class="breadcrumb-item" href="{{route('featured.view')}}"> Featured Products</a>
        ...
        <div class="row row-sm mg-t-20">
          <div class="col-xl-12">
            <div class="card pd-20 pd-sm-40 form-layout form-layout-4">
              <h6 class="card-body-title">Edit Featured Product</h6>
              <div class="row">
              ...
              <div class="row mg-t-20">
               ...
               <input type="file" name="" id="img">
                ...
                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                       <textarea rows="2"  id="des" class="form-control">{{$product->des}}</textarea>
                </div>
              </div>
